...
<div id="ani" class="pink"></div>
	<div class="td-containern">
		...
		<h1 style="margin-bottom:-4%;color: darkred;font-weight: bold;" id="time"></h1>
...
echo "	<div class=\"td-sheet\">
	...
	<div class=\"container\">
		<div class=\"row site-title\">
			...
			<input id=\"env\" style=\"width:20%;heigth:120%;\" type=\"submit\" name=\"submit\" value=\"Envoyez\" class=\"btn btn-danger btn-lg float-right\">	
		</div>		    
	    </form>
	</div>
</div>";
...
echo "	<div class=\"td-sheet\">
	...
	<div class=\"container\">
		<div class=\"row site-title\">
				...
				<!-- Group of default radios - option 1 -->
				<div class=\"custom-control custom-radio\" style=\"font-family: 'Domine', serif; text-align: center;text-shadow: 3px 2px blue; font-size:200%;\">
