if(!tdMobile){
	//set up
	var direction = "Y"; // X for vertical spinning, Y for horizontal spinning
	var tdSheetHeight = 100; // Height of sheets (measured in %)
	var tdSheetWidth = 100; // Width of sheets (measured in %)
	var tdSheetCorner = 0; // Corner's curves
	var tdSheetDist = 0; // Gap between sheets union (Measured in window's height
